...
Figure *GameController::getCurrentFigure() { return this->currentFigure; }

void GameController::tick() { this->moveDown(); }
...
void GameController::setGameStatus(GameStatus gs) { status = gs; }

GameStatus GameController::getGameStatus() { return status; }

int GameController::getPhysicsDelay() { return physics_delay; }
